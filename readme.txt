...
- **Correção:** Cobrança de taxas e impostos (fees) na Vindi para faturas avulsas e assinaturas.
- **Correção:** Envio do valor da taxa em assinaturas utilizando pricing_schema.
- **Correção:** Payload de bill_items, evitando o envio simultâneo de product_id e product_code.
...
= 1.4.1 - 08/08/2025 =
-Lançamento da versão de patch.
- **Melhoria:** Alteração no nome do plugin.

= 1.4.0 - 31/07/2025 =
-Lançamento da versão de patch.
- **Correção:** fatal error ao excluir posts.
...
- **Melhoria:** Adição de uma nova rota para validar a existência do usuário.
...
Vindi Hub is free software: you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation, either version 3 of the License, or (at your option) any later version.

Vindi Hub is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the GNU General Public License for more details.
